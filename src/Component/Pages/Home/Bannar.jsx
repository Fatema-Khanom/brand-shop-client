...
// const Bannar = () => {
//     return (
//         <div className="w-/12 m-auto my-10">
...
const Bannar = () => {
    return (
        <div className="w-full m-auto my-10">
            ...
            <div className="hero-content text-center text-neutral-content dark:text-white">
                <div className="max-w-md">
                <h1 className="mb-5 text-4xl font-bold">Explore Our Exquisite Car Collection</h1>
            
                <p className="mb-5">Discover the latest models and experience luxury like never before. Explore our wide range of vehicles, each designed to elevate your driving experience.</p>
                <button className="bg-gray-700 dark:bg-gray-900 text-white py-2 px-4 rounded hover:bg-gray-500 dark:hover:bg-gray-800">Explore Now</button>
                </div>
            </div>
            </div>
        </div>
